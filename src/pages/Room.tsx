...
import styles from '../styles/pages/pageRoom.module.scss';
...
const Room: React.FC = () => {
  ...
  async function handleSendQuestion(event: FormEvent) {
    ...
    if(!user) {
      throw new Error ('Você não esta autenticado, faça o login para enviar sua pergunta.')
    }
    ...
    <div className={styles.pageRoom} >
      ...
      <main>
        ...
        <form onSubmit={handleSendQuestion}>
          <textarea 
            placeholder="Faça sua pergunta. O que você quer perguntar?"
            value={newQuestion}
